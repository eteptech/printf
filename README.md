# _printf
```_printf``` is a custom implementation of the C programming function ```printf```. This project is an application of the C programming knowledge that [Alx  School](https://www.alxafrica.com) cohort 9 students have learned.
...
## Authors
[Emmanuel Ugbem ](https://github.com/eteptech) | [Providence Allen](https://github.com/lacxis)
